...
Zmodyfikowaliśmy parametry tak, aby przeszukiwać przestrzeń mniejszymi krokami: kMax = 1500, density = 0.05
Rezultat był następujący:


```{r cec8_2_table20_higher_density}
```
...
Dobrane zostały: kMax = 1500, density = 0.05

```{r cec14_2_table20_higher_density}
```
